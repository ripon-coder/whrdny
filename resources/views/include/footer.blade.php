@php
    function splitAddress($address) {
        return array_pad(explode(',', $address, 2), 2, '');
    }

    [$num1, $num2] = splitAddress($g_settings->address_one_mobile);
    [$num3, $num4] = splitAddress($g_settings->address_two_mobile);
@endphp
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 mb-4 mb-md-0">
                    <a class="footer_logo" href="{{ url('/') }}">
                        <img class="img-fluid" src="{{ asset('dynamic-assets/footer_logo/' . $g_settings->footer_logo) }}"
                            alt="logo" />
                    </a>
                    <div class="">
                        <div class="textwidget mt-3">
                            <div class="compay_location us-office mb-3">
                                ...
                                <div class="d-flex mb-1">
                                    <i class="fa fa-phone"></i><a href="tel:{{$num1}}"> {{ $num1 }}</a>,&nbsp;<a href="tel:{{$num2}}"> {{ $num2 }}</a>
                                </div>
                                <div class="d-flex mb-1">
                                    <i class="fa fa-envelope-o"></i> <a
                                        href="mailto:{{ @$g_settings->address_one_email }}">{{ @$g_settings->address_one_email }}</a>
                                </div>
                                <div class="d-flex mb-1">
                                    <i class="fa fa-map-marker"></i> {{ strip_tags(@$g_settings->address_one_address) }}
                                </div>
                            </div>
                            <div class="compay_location">
                                ...
                                <div class="d-flex mb-1">
                                    <i class="fa fa-phone"></i><a href="tel:{{$num3}}"> {{ $num3 }}</a>,&nbsp;<a href="tel:{{$num4}}"> {{ $num4 }}</a>
								</div>

                                <div class="d-flex mb-1"><i class="fa fa-envelope-o"></i> <a
                                        href="mailto:{{ @$g_settings->address_two_email }}">{{ @$g_settings->address_two_email }}</a>
                                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="copyright text-center d-md-flex justify-content-center align-items-center">
                <p class="copyright mb-0"><span class="txt-block copyright_text">Copyright © World Human Rights
                        Development USA (WHRD) {{ date('Y') }}. Powered by</span></p>
