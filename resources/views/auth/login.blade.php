                                    ...
                                    <div class="card-title text-center">
                                        <div class="p-1">
                                            @if ( isset($g_settings->logo) )
                                                <img style="max-width: 245px" src="{{ asset('dynamic-assets/logo/'.$g_settings->logo) }}" alt="branding logo">
                                            @else
                                            <img style="max-width: 245px" src="{{ asset('dynamic-assets/logo/logo-2.png') }}" alt="branding logo">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" method="post" action="{{ route('login') }}">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mb-0" style="bottom:20px">
                                                <input type="email" name="email" value="{{ old('email') }}" class="form-control" id="user-name" placeholder="Enter Email" required>
