...
@section('pageHeading')
    @include('admin.app.page-heading', ['text'=>'Dashboard / History'] )
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">History</h4>
                </div>
                        ...
                        <form class="form form-horizontal" id="profileForm" method="post" action="{{ route('admin.history.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <textarea class="form-control summernote" name="description">{!!@$history->description!!}</textarea>
                                    </div>
                                </div>
                            </div>
