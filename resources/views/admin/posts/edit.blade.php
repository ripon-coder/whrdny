...
@section('pageHeading')
    @include('admin.app.page-heading', ['text' => 'Dashboard / Post / Update Post'])
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-basic">Update Post</h4>
                    </div>
                            ...
                            <form class="form form-horizontal" id="sliderform" method="post"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input required type="text" value="{{ $post->title }}" class="form-control"
                                                name="title">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input required type="text" value="{{ $post->author }}" class="form-control"
                                                name="author">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <textarea required class="form-control summernote" name="description">{{ $post->description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control">Publish Date</label>
                                        <div class="col-md-9 mx-auto">
                                            <input required type="date" value="{{ date('Y-m-d', strtotime($post->publish_date)) }}" class="form-control"
                                                name="publish_date">
                                        </div>
                                    </div>
                                </div>
