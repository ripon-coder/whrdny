...
@section('pageHeading')
    @include('admin.app.page-heading', ['text' => 'Dashboard / Photo Gallery / Upload Photo'])
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-basic">Upload Photo</h4>
                    </div>
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <div class="card-text"></div>
                            <form class="form form-horizontal" id="sliderform" method="post"
                                action="{{ route('admin.photo-gallery.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
