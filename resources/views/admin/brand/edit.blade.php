...
@section('pageHeading')
    @include('admin.app.page-heading', ['text' => 'Dashboard / Brand / Edit Brand'])
@endsection
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" id="sliderform" method="post"
                                action="{{ route('admin.brand-admin.update',$brand) }}" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input required type="text" value="{{ $brand->title }}" class="form-control"
                                                name="title">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            ...
                                            <img class="mt-1" width="50" src="{{ asset('dynamic-assets/brand/' . $brand->image) }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <select class="form-control" name="status">
                                                @foreach ($BrandEnum as $value)
                                                    <option @selected($value==$brand->status) value="{{$value}}">{{$value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
