...
@section('pageHeading')
    @include('admin.app.page-heading', ['text' => 'Dashboard / Vission'])
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-basic">Vission</h4>
                    </div>
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <div class="card-text"></div>
                            <form class="form form-horizontal" id="profileForm" method="post"
                                action="{{ route('admin.vission.update') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input required type="text" value="{{ @$vission->title }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <textarea class="form-control summernote" name="description">{!! @$vission->description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control">Button URL</label>
                                        <div class="col-md-9 mx-auto">
                                            <input type="url" value="{{ @$vission->button_url }}" class="form-control"
                                                name="button_url">
                                        </div>
                                    </div>
                                    <div class="form-group row">
