...
@section('pageHeading')
    @include('admin.app.page-heading', ['text' => 'Dashboard / Video Gallery / Upload Video'])
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-basic">Upload Video</h4>
                    </div>
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <div class="card-text"></div>
                            <form class="form form-horizontal" id="sliderform" method="post"
                                action="{{ route('admin.video-gallery.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    ...
                                    @endif
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control">Video(youtube embed video - width-555 - height-312)</label>
                                        <div class="col-md-9 mx-auto">
                                            <textarea required type="text" class="form-control"
                                                name="video">{{ old('name') }}</textarea>
                                        </div>
                                    </div>
